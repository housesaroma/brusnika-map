...
export const DEMO_BUILDINGS = [
  ...
  {
    id: 'b3',
    address: 'ул. Белинского, 108',
    district: 'Верх-Исетский',
    lat: 56.827,
    lng: 60.613,
    floors: 25,
    year_built: 2022,
    material: 'monolith_brick',
    nearest_metro: 'Чкаловская',
  ...
  },
  {
    ...
    material: 'panel',
    nearest_metro: 'Чкаловская',
    metro_distance_min: 6,
    flat_count: 2,
  },
  {
    id: 'b5',
    address: 'ул. Репина, 78',
    district: 'Верх-Исетский',
    lat: 56.832,
    lng: 60.58,
    floors: 18,
    year_built: 2020,
    material: 'monolith',
    nearest_metro: 'Динамо',
    metro_distance_min: 10,
    flat_count: 6,
  },
  {
    id: 'b6',
    address: 'ул. Токарей, 40',
    district: 'ВИЗ',
    lat: 56.845,
    lng: 60.57,
    floors: 22,
  ...
  },
  {
    ...
    year_built: 2010,
    material: 'panel',
    nearest_metro: 'Проспект Космонавтов',
    metro_distance_min: 4,
    flat_count: 4,
  },
  {
    id: 'b8',
    address: 'ул. Крауля, 56',
    district: 'ВИЗ',
    lat: 56.841,
    lng: 60.563,
    floors: 14,
  ...
  },
  {
    ...
    material: 'monolith_brick',
    nearest_metro: 'Чкаловская',
    metro_distance_min: 9,
    flat_count: 5,
  },
  {
    id: 'b10',
    address: 'ул. Сурикова, 31',
    district: 'Центр',
    lat: 56.835,
    lng: 60.602,
    floors: 8,
...
function generateFlats(building, count) {
  ...
  for (let i = 0; i < count; i++) {
    ...
    const basePricePerSqm =
      building.district === 'Центр'
        ? 130000
        : building.district === 'Верх-Исетский'
          ? 110000
          : building.district === 'ВИЗ'
            ? 105000
            : 85000;
  ...
  return allFlats
    ...
    .map((f) => ({
      ...
      similarity:
        1 /
        (1 +
          Math.abs(f.rooms - flat.rooms) * 0.3 +
          Math.abs(f.area - flat.area) * 0.01 +
          Math.abs(f.floor - flat.floor) * 0.05 +
          (f.district === flat.district ? 0 : 0.5)),
    }))
