        ...
        <div className="overflow-y-auto flex-1 pr-1 space-y-4 mt-2">
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <Input type="number" placeholder="1" value={filters.rooms_min} onChange={e => update('rooms_min', e.target.value)} />
            </div>
            <div className="space-y-1.5">
              <Label className="text-xs">Комнат до</Label>
              <Input type="number" placeholder="5" value={filters.rooms_max} onChange={e => update('rooms_max', e.target.value)} />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <Input type="number" placeholder="20" value={filters.area_min} onChange={e => update('area_min', e.target.value)} />
            </div>
            <div className="space-y-1.5">
              <Label className="text-xs">Площадь до (м²)</Label>
              <Input type="number" placeholder="200" value={filters.area_max} onChange={e => update('area_max', e.target.value)} />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <Input type="number" placeholder="1 000 000" value={filters.price_min} onChange={e => update('price_min', e.target.value)} />
            </div>
            <div className="space-y-1.5">
              <Label className="text-xs">Цена до (₽)</Label>
              <Input type="number" placeholder="20 000 000" value={filters.price_max} onChange={e => update('price_max', e.target.value)} />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <Input type="number" placeholder="1" value={filters.floor_min} onChange={e => update('floor_min', e.target.value)} />
            </div>
            <div className="space-y-1.5">
              <Label className="text-xs">Этаж до</Label>
              <Input type="number" placeholder="25" value={filters.floor_max} onChange={e => update('floor_max', e.target.value)} />
            </div>
          </div>
